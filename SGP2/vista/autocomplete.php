...
$ssql = "select * from tbcliente where  nombre_apellido like '%" . $datoBuscar . "%'";
$rs = mysql_query($ssql);
...
while ($fila = mysql_fetch_array($rs)){
   array_push($arrayElementos, new ElementoAutocompletar(utf8_encode($fila["nombre_apellido"]), $fila["nombre_apellido"]));
}

...
$ssql = "select * from operario where CEDULA like '%" . $datoBuscar . "%'";
$rs = mysql_query($ssql);
...
while ($fila = mysql_fetch_array($rs)){
   array_push($arrayElementos, new ElementoAutocompletar(utf8_encode($fila["NOMBRE"].' '.$fila['APELLIDO']), $fila["CEDULA"]));
}
